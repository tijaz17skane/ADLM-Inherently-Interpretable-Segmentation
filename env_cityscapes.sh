...
export SOURCE_DATA_PATH='/shared/sets/datasets/cityscapes'
export DATA_PATH='/shared/sets/datasets/cityscapes'
export LOG_DIR='./logs'
...
export TRAIN_DIR='/shared/sets/datasets/cityscapes'
export TRAIN_PUSH_DIR='/shared/sets/datasets/cityscapes'
